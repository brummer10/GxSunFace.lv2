...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
    ...
    gx_SunFaceUI* ui = (gx_SunFaceUI*)arg->ui;
    if (ui->block) {
        ui->block = 0;
        return;
    }
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    const char* plug_name = "GxSunFace" ;
    ...
    set_expose_func(GX_SUNFACE_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    ui->label[0] = gtk_label_new("DRIVE");
    ...
    ui->args[0]->ui = ui;
    ui->args[0]->port_index = (int)DRIVE;
    ...
    ui->label[1] = gtk_label_new("INPUT");
    ...
    ui->args[1]->ui = ui;
    ui->args[1]->port_index = (int)INPUT;
